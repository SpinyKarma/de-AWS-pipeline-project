...
def test_output_body_is_pandas_dataframe():
    """ Test whether the 'Body' value in the output dictionary of the function
        'currency_to_dim_currency' is a Pandas DataFrame.
    """
    output = dcy(test_input_dict)
...
def test_output_body_has_expected_transformation_applied():
    """ Test whether the function 'currency_to_dim_currency' correctly
        transforms the input DataFrame and returns the expected output.
    """
    output = dcy(test_input_dict)
    test_output = {
        'Key': '2023-07-31T12:24:11.422525/currency.csv',
