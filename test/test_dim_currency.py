import pandas as pd
from src.lambda_transformation.utils.dim_currency import currency_to_dim_currency
...
def test_timestamp_carried_over():
    output = currency_to_dim_currency(test_input_dict)
