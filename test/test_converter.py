...
def test_convert_warehouse_credentials_returns_valid_json():
    ...
    assert converter.convert_warehouse_credentials(
        '1234', 'exampleschema', 'exampleuser', 'examplepassword') == example
...
def test_convert_ingestion_wraehouse_returns_valid_json():
    ...
    assert converter.convert_ingestion_credentials(
        'examplehostname', '1234', 'exampledb', 'exampleusername', 'examplepassword') == example
